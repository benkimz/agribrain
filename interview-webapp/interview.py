...
banner_image = Image.open(r"images/solutionchallenge-2023-Website-EventBanners_Full.png")
...
questions_dir, placeholders_dir, options_dir = "questions/", "placeholders/", "options/"
...
response_file = "./feedback/responses-{}.csv".format(language)
